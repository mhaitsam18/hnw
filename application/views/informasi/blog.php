...
<div id="content_wrapper">
	...
	<div class="page_title" data-stellar-background-ratio="0" data-stellar-vertical-offset="0" style="background-image:url(<?= base_url('assets/') ?>images/bg/page_title_bg.jpg);">
		<ul>
			<li>Blog</li>
			<li><a href="<?= base_url('Informasi/blog') ?>">Berita</a></li>
							...
							<div class="panel panel-default">
								...
								<div class="panel panel-default">
									<div class="panel-heading" role="tab" id="headingThree">
										<h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Recent_blog" aria-expanded="false"> blog Baru</a> </h4>
									</div>
					...
					<?php if ($num_blog) : ?>
						...
						<?php foreach ($blog as $item) : ?>
							<div class="travel_post">
								...
								?>
								<?= $isi ?>
								<a href="<?= base_url('Informasi/detail/blog/' . $item['id']) ?>" class="btn-travel btn-green">Baca Selengkapnya</a>
							</div>
						<?php endforeach ?>
