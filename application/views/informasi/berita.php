							...
							<div class="panel panel-default">
								...
								<div class="panel panel-default">
									<div class="panel-heading" role="tab" id="headingThree">
										<h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Recent_berita" aria-expanded="false"> berita Baru</a> </h4>
									</div>
									<div id="Recent_berita" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
										<div class="panel-body">
											<aside class="widget widget_recent_entries">
												<ul>
													<li>
														<img src="<?= base_url('assets/') ?>images/berita/recent_berita_footer1.jpg" alt="Recent berita" />
														<div>
															<p>Nunc cursus libero purus ac congue arcu cursus..</p>
															<a href="#">Baca Selengkapnya</a>
														</div>
													</li>
													<li> <img src="<?= base_url('assets/') ?>images/berita/recent_berita_footer2.jpg" alt="Recent berita" />
														<div>
															<p>Nunc cursus libero purus ac congue arcu cursus..</p>
															<a href="#">Baca Selengkapnya</a>
														</div>
					...
					<?php if ($num_berita) : ?>
						...
						<?php foreach ($berita as $item) : ?>
							<div class="travel_post">
								...
								?>
								<?= $isi ?>
								<a href="<?= base_url('Informasi/detail/berita/' . $item['id']) ?>" class="btn-travel btn-green">Baca Selengkapnya</a>
							</div>
						<?php endforeach ?>
