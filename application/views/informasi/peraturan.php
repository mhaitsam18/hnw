						...
						<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							...
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingThree">
									<h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Recent_peraturan" aria-expanded="false"> Peraturan Baru </a> </h4>
								</div>
					...
					<?php if ($num_peraturan) : ?>
						...
						<?php foreach ($peraturan as $item) : ?>
							<div class="travel_post">
								...
								?>
								<?= $isi ?>
								<a href="<?= base_url('Informasi/detail/peraturan/' . $item['id']) ?>" class="btn-travel btn-green">Baca Selengkapnya</a>
							</div>
						<?php endforeach ?>
