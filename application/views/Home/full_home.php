...
<body class="travel_home">
				...
				<div class="container">
					<div class="row">	
						<div class="col-md-6 col-sm-6">
							<?php $dashboard = $this->db->get_where('dashboard', ['id' => 1])->row_array(); ?>
							<p><i class="fa fa-phone"></i> For Support? Call Us: <span><?= $dashboard['contact'] ?></span></p>
						</div>
						<div class="col-md-6 col-sm-6">
							<div class="top_menu">
								<ul>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-2 col-sm-2">
							<div class="travel_logo"> <a href="Home_01.html"><img src="<?= base_url('assets/') ?>svg/Logo.svg" alt="logo" /></a></div>
						</div>
									...
									<ul style="width:100% !important;">
										...
										<li data-index="rs-391" data-transition="parallaxhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Smooth Mask" data-description="">
											...
											<div class="slider_heading_wrap">
												...
												<!-- LAYER NR. 1 -->
												<!-- LAYER NR. 2 -->
												<div class="tp-caption NotGeneric-Title   tp-resizeme" id="slide-391-layer-2" data-x="680" data-hoffset="" data-y="center" data-voffset="35" data-width="['auto','auto','auto','auto']" data-height="['auto','auto','auto','auto']" data-transform_idle="o:1;" data-transform_in="x:right;s:2000;e:Power4.easeInOut;" data-transform_out="s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-start="2000" data-splitin="none" data-splitout="none" data-responsive_offset="on">
													<div class="tour_packages" style="font-size:26px;">Tour Packages Starts@ <span style="font-size:38px;">$260</span></div>
												</div>
												<!-- LAYER NR. 2 -->
												<!-- LAYER NR. 3 -->
												<div class="slider_buttons tp-caption NotGeneric-Title slideheading  tp-resizeme" id="slide-391-layer-3" data-x="680" data-y="center" data-voffset="80" data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:2000;e:Power4.easeInOut;" data-transform_out="s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-start="3000" data-splitin="none" data-splitout="none" data-responsive_offset="on">
										...
										<li data-index="rs-392" data-transition="parallaxhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Slide Mask" data-description="">
											<!-- MAIN IMAGE -->
											<img src="<?= base_url('assets/') ?>images/Home/home-2-slide.jpg" alt="slide3" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
											<!-- LAYER NR. 1 -->
											<div class="slider_heading_wrap">
												<!-- LAYER NR. 1 -->
												<div class="tp-caption NotGeneric-Title tp-resizeme" id="slide-392-layer-1" data-x="680" data-hoffset="" data-y="center" data-voffset="-120" data-width="['auto','auto','auto','auto']" data-height="['auto','auto','auto','auto']" data-transform_idle="o:1;" data-transform_in="y:top;s:2000;e:Power4.easeInOut;" data-transform_out="s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-start="1000" data-splitin="none" data-splitout="none" data-responsive_offset="on" style="text-align:center;">
													<div style="font-size:36px; line-height:45px;" class="travelite_slider_text"> once a year</div>
													<div style="font-size:40px; line-height:45px;" class="travelite_slider_text"> Go SomePlace</div>
													<div style="font-size:30px; line-height:45px;" class="travelite_slider_text"> You’ve Never</div>
													<div style="font-size:48px; line-height:45px;" class="travelite_slider_text bottom_line_text"> Been Before</div>
												...
												<!-- LAYER NR. 1 -->
												<!-- LAYER NR. 2 -->
												<div class="tp-caption NotGeneric-Title   tp-resizeme" id="slide-392-layer-2" data-x="680" data-hoffset="" data-y="center" data-voffset="35" data-width="['auto','auto','auto','auto']" data-height="['auto','auto','auto','auto']" data-transform_idle="o:1;" data-transform_in="x:right;s:2000;e:Power4.easeInOut;" data-transform_out="s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-start="2000" data-splitin="none" data-splitout="none" data-responsive_offset="on">
													<div class="tour_packages" style="font-size:26px;">Tour Packages Starts@ <span style="font-size:38px;">$260</span></div>
												</div>
												<!-- LAYER NR. 2 -->
												<!-- LAYER NR. 3 -->
												<div class="slider_buttons tp-caption NotGeneric-Title slideheading tp-resizeme" id="slide-392-layer-3" data-x="680" data-y="center" data-voffset="80" data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:2000;e:Power4.easeInOut;" data-transform_out="s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-start="3000" data-splitin="none" data-splitout="none" data-responsive_offset="on">
													<a href="#"  style=" border: 1px solid #fdb714;" class="large_slide_btn">View more</a>
													<a href="#"  style=" border: 1px solid #fdb714;" class="large_slide_btn">book now</a>
												</div>
												<!-- LAYER NR. 3 -->
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="feature_box_second">
								<img src="<?= base_url('assets/') ?>images/Home/feature1.jpg" class="img-responsive" alt="feature">
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="feature_box_second">
								<img src="<?= base_url('assets/') ?>images/Home/feature2.jpg" class="img-responsive" alt="feature">
								<div class="feature_overlay_second">
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="feature_box_second">
								<img src="<?= base_url('assets/') ?>images/Home/feature3.jpg" class="img-responsive" alt="feature">
								<div class="feature_overlay_second">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class=" full_width offer_box_wrapper">
								...
								<div class="img_overlay_wrapper">
									<img src="<?= base_url('assets/') ?>images/Home/offer-1.jpg" class="img-responsive" alt="offer">
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class=" full_width offer_box_wrapper">
								...
								<div class="img_overlay_wrapper">
									<img src="<?= base_url('assets/') ?>images/Home/offer-2.jpg" class="img-responsive" alt="offer">
									<div class="img_overlay">
									</div>
								</div>
								<div class="full_width offer_inner">
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class=" full_width offer_box_wrapper">
								...
								<div class="img_overlay_wrapper">
									<img src="<?= base_url('assets/') ?>images/Home/offer-3.jpg" class="img-responsive" alt="offer">
									<div class="img_overlay">
									</div>
								</div>
								<div class="full_width offer_inner">
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class=" full_width offer_box_wrapper">
								...
								<div class="img_overlay_wrapper">
									<img src="<?= base_url('assets/') ?>images/Home/offer-4.jpg" class="img-responsive" alt="offer">
									<div class="img_overlay">
									</div>
								</div>
								<div class="full_width offer_inner">
						...
						<div id="home_testimonials" class="owl-carousel owl-theme">
							...
							<div class="item">
								<div class="col-lg-6 col-md-6 col-sm-6 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 pad_z">
									<div class="main_testimonials_content">
										<p>
											Create stunning pages with our powerful admin panel. Functionality and usability combine. Travelllers Deals and Offers on Hotels, Vacation Packages, Flights, Cruises and Car Rentals.
											<b>“Create stunning pages with our powerful admin panel. Functionality and usability combine.”</b>
											Deals and Offers on Hotels, Vacation Packages, Flights, Cruises and Car Rentals
										</p>
									</div>
								</div>
								<div class="col-lg-4 col-md-4 col-sm-4 pad_z">
									<div class="testimonial_img_part">
										<img src="<?= base_url('assets/') ?>images/Home/testimonial-thumb.png" class="img-circle" alt="testimonial-thumb">
										<h4>Ana Levley</h4>
										<p>HeapsTech, CEO</p>
									</div>
								</div>
							...
							<div class="item">
								<div class="col-lg-6 col-md-6 col-sm-6 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 pad_z">
									<div class="main_testimonials_content">
										<p>
											Create stunning pages with our powerful admin panel. Functionality and usability combine.
								...
								<div class="col-lg-4 col-md-4 col-sm-4 pad_z">
									<div class="testimonial_img_part">
										<img src="<?= base_url('assets/') ?>images/Home/Hnmn2.jpg" class="img-circle" alt="testimonial-thumb">
										<h4>Ana Levley</h4>
										<p>HeapsTech, CEO</p>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-md-4">
						<aside class="widget widget_text"> 
							...
							<p>
								In 2015, We launched Travellers with the belief that other travellers would share our desire to experience authentic adventures in a responsible and sustainable manner. <br> <br> We've grown from a one-man show to a company of over 50 world wide, and from a handful of trips in all over the world.
							</p>
					...
					<div class="col-md-4">
						...
						<aside class="widget widget_links">
							...
							<ul>
								<?php $lainnya = $this->db->get_where('user_sub_menu',['menu_id' => 15])->result_array() ?>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 text-right"> <span>Travellers@2018. All Right Reserved</span> </div>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- REVOLUTION JS FiLES -->
	<!-- video_popup -->
	<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/video-popup/jquery.magnific-popup.js"></script><!-- video_popup --><!-- slick slider -->
